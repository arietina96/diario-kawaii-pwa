// **IMPORTANTE: Aggiornato a v5 per forzare l'eliminazione della cache precedente**
const CACHE_NAME = 'diario-kawaii-cache-v5'; 
...
  // Elimina tutte le cache precedenti che non corrispondono a CACHE_NAME (v5)
  evt.waitUntil(
